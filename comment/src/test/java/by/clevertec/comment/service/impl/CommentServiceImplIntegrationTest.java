...
import by.clevertec.comment.util.TestConstant;
...
class CommentServiceImplIntegrationTest {
    ...
    class GetAllTest {
        ...
        private final PageRequest pageRequest = PageRequest.of(TestConstant.PAGE_NUMBER, TestConstant.PAGE_SIZE);
    ...
    class GetByIdTest {
        ...
        void getShouldThrowCustomEntityNotFoundException_whenIncorectId() {
            CustomEntityNotFoundException expectedException = CustomEntityNotFoundException.of(Comment.class, TestConstant.INCORRECT_ID);

            when(commentRepository.findById(TestConstant.INCORRECT_ID))
                    .thenReturn(Optional.empty());

            CustomEntityNotFoundException actualException = assertThrows(CustomEntityNotFoundException.class, () -> commentService.getById(TestConstant.INCORRECT_ID));
    ...
    class SaveTest {
        ...
        void saveShouldSaveComment_whenCommentAndNameRequestDtoTransferredWithCorrectParameter() {
            ...
            Author author = new Author(TestConstant.AUTHOR_NAME);

            when(commentMapper.toDomain(commentRequestDto))
                    .thenReturn(comment);
            when(authorService.getByName(TestConstant.AUTHOR_NAME))
                    .thenReturn(author);
    ...
    class UpdateTest {
        ...
        void updateShouldThrowCustomEntityNotFoundException_whenIncorrectId() {
            ...
            assertThrows(CustomEntityNotFoundException.class, () -> commentService.update(TestConstant.INCORRECT_ID, any(CommentAndNameRequestDto.class)));
        ...
        void updateShouldThrowCustomAccessException_whenHasNotRightToModify() {
            ...
            assertThrows(CustomAccessException.class, () -> commentService.update(TestConstant.CORRECT_ID, commentAndNameRequestDto));
            verify(commentMapper, never()).toDomain(any(CommentRequestDto.class));
            verify(commentMapper, never()).merge(any(Comment.class), any(Comment.class));
        }
        ...
        void updateShouldUpdateComment_whenCorrectIdAndNameAndDtoTransferred() {
            ...
            commentService.update(TestConstant.CORRECT_ID, requestDto);
        }
    ...
    class UpdatePathTest {
        ...
        void updateShouldThrowCustomEntityNotFoundException_whenIncorrectId() {
            ...
            assertThrows(CustomEntityNotFoundException.class, () -> commentService.updatePath(TestConstant.INCORRECT_ID, any(CommentAndNamePathRequestDto.class)));
            verify(commentMapper, never()).toDomain(any(CommentRequestDto.class));
            verify(commentMapper, never()).merge(any(Comment.class), any(Comment.class));
        }
        ...
        void updateShouldThrowCustomAccessException_whenHasNotRightToModify() {
            ...
            assertThrows(CustomAccessException.class, () -> commentService.updatePath(TestConstant.CORRECT_ID, requestDto));
            verify(commentMapper, never()).toDomain(any(CommentRequestDto.class));
            verify(commentMapper, never()).merge(any(Comment.class), any(Comment.class));
        }
        ...
        void updateShouldUpdateComment_whenCorrectIdAndNameAndDtoTransferred() {
            ...
            commentService.updatePath(TestConstant.CORRECT_ID, requestDto);
        }
    ...
    class DeleteTest {
        ...
        void deleteShouldDeleteComment_whenCorrectIdAndUsername() {
            ...
            commentService.delete(TestConstant.CORRECT_ID, TestConstant.AUTHOR_NAME);
        }
        ...
        void deleteShouldDeleteComment_whenCorrectIdAndUserIsAdmin() {
            ...
            commentService.delete(TestConstant.CORRECT_ID, admin);
        }
        ...
        void deleteShouldThrowCustomEntityNotFoundException_whenIncorrectId() {
            ...
            CustomEntityNotFoundException actualException = assertThrows(CustomEntityNotFoundException.class, () -> commentService.delete(TestConstant.INCORRECT_ID, TestConstant.AUTHOR_NAME));
        ...
        void deleteShouldCustomAccessException_whenHasNotRightToModify() {
            ...
            CustomAccessException actualException = assertThrows(CustomAccessException.class, () -> commentService.delete(TestConstant.CORRECT_ID, name));
    ...
    class TestGetAllByNewsId {
        ...
        void getAllByNewsIdShouldThrowCustomNoContentException_whenFoundedCommentsListEmpty() {
            ...
            when(commentRepository.findByNewsId(TestConstant.INCORRECT_ID, pageRequest))
                    .thenReturn(page);

            CustomNoContentException actualException = assertThrows(CustomNoContentException.class, () -> commentService.getAllByNewsId(TestConstant.INCORRECT_ID, pageRequest));
